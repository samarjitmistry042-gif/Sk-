    ...
    <div className="flex flex-col bg-primary-black min-h-screen pt-24 pb-24">
      <div className="container mx-auto px-6 md:px-12 max-w-5xl">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-brand font-bold text-white mb-6">Schedule an Appointment</h1>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
            Please select the division or sub-company you require an appointment with. Our team will assist you with commercial projects, infrastructure requirements, and more.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {COMPANIES.map((company) => (
            <Link
              key={company.id}
              to={`/company/${company.id}/project-request`}
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex items-center text-primary-gold text-sm font-semibold uppercase tracking-wider">
                  Book Appointment <ArrowRight className="w-4 h-4 ml-2 transform group-hover:translate-x-1 transition-transform" />
                </div>
              </div>
            </Link>
          ))}
